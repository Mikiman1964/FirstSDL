...
void ControlNut(uint32_t I) {
    ...
    if (    ((Playfield.pStatusAnimation[I] & 0xFF000000) == EMERALD_ANIM_BORN1) ||
        ...
        Playfield.pStatusAnimation[I + Playfield.uLevel_X_Dimension] = EMERALD_ANIM_DOWN_SELF | EMERALD_NUT | EMERALD_ANIM_CLEAN_UP;
        ...
        Playfield.pStatusAnimation[I] = EMERALD_NUT;
        ...
        if ( (Playfield.pStatusAnimation[I] & 0xFF000000) == EMERALD_ANIM_DOWN_SELF) {
            ...
            if ( (Playfield.pLevel[I + Playfield.uLevel_X_Dimension] == EMERALD_WALL_SOFT_ROUND_PIKE) || (Playfield.pLevel[I + Playfield.uLevel_X_Dimension] == EMERALD_STEEL_ROUND_PIKE) ) {
        ...
        if ((Playfield.uRollUnderground[Playfield.pLevel[I + Playfield.uLevel_X_Dimension]] & EMERALD_CHECKROLL_NUT) != 0) {
            ...
            if (uFree == 1) {   // Nut kann links rollen
                ...
                // Damit ungültiges Feld später auf richtiges Element gesetzt werden kann
                Playfield.pStatusAnimation[I - 1] = EMERALD_NUT | EMERALD_ANIM_CLEAN_RIGHT;
                ...
                Playfield.pLevel[I + 1] = EMERALD_INVALID;
                // Damit ungültiges Feld später auf richtiges Element gesetzt werden kann
                Playfield.pStatusAnimation[I + 1] = EMERALD_NUT | EMERALD_ANIM_CLEAN_LEFT;
