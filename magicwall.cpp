...
void ElementGoesMagicWall(uint32_t I, uint32_t uDestElement) {
    if (Playfield.pLevel[I + 2 * Playfield.uLevel_X_Dimension] == EMERALD_SPACE) {
        ...
        Playfield.pStatusAnimation[I + 2 * Playfield.uLevel_X_Dimension] = EMERALD_ANIM_DOWN_SELF | uDestElement | EMERALD_ANIM_CLEAN_UP_DOUBLESPEED;
        ...
        Playfield.pStatusAnimation[I + Playfield.uLevel_X_Dimension] = uDestElement | EMERALD_ANIM_SAG_OUT_MAGIC_WALL | EMERALD_ANIM_AVOID_DOUBLE_CONTROL;
    } else {
