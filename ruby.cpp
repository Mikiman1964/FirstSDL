...
void ControlRuby(uint32_t I) {
    ...
    if (    ((Playfield.pStatusAnimation[I] & 0xFF000000) == EMERALD_ANIM_BORN1) ||
        ...
        Playfield.pStatusAnimation[I + Playfield.uLevel_X_Dimension] = EMERALD_ANIM_DOWN_SELF | EMERALD_RUBY | EMERALD_ANIM_CLEAN_UP;
        ...
        Playfield.pStatusAnimation[I] = EMERALD_RUBY;
        ...
        if ( (Playfield.pStatusAnimation[I] & 0xFF000000) == EMERALD_ANIM_DOWN_SELF) {
            ...
            if (Playfield.pLevel[I + Playfield.uLevel_X_Dimension] == EMERALD_MAGIC_WALL) { // Rubin trifft auf Magic wall
        ...
        Playfield.pStatusAnimation[I] |= EMERALD_ANIM_STAND;
        if ((Playfield.uRollUnderground[Playfield.pLevel[I + Playfield.uLevel_X_Dimension]] & EMERALD_CHECKROLL_RUBY) != 0) {
            uFree = GetFreeRollDirections(I);
            if (uFree == 1) {   // Rubin kann links rollen
                // neuen Platz mit ungültigem Element besetzen
                Playfield.pLevel[I - 1] = EMERALD_INVALID;
                // Damit ungültiges Feld später auf richtiges Element gesetzt werden kann
                Playfield.pStatusAnimation[I - 1] = EMERALD_RUBY | EMERALD_ANIM_CLEAN_RIGHT;
                ...
                Playfield.pLevel[I + 1] = EMERALD_INVALID;
                // Damit ungültiges Feld später auf richtiges Element gesetzt werden kann
                Playfield.pStatusAnimation[I + 1] = EMERALD_RUBY | EMERALD_ANIM_CLEAN_LEFT;
