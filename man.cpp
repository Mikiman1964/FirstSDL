...
uint32_t ManTouchElement(uint32_t uActPos, uint32_t uTouchPos, uint32_t uAnimation) {
    ...
    switch (uElement) {
        ...
        case (EMERALD_EMERALD):
            if ((Playfield.pStatusAnimation[uTouchPos] & 0xFF000000) == EMERALD_ANIM_SINK_IN_MAGIC_WALL) {
        ...
        case (EMERALD_MAGIC_WALL):
            if ((uAnimation != EMERALD_ANIM_STAND) && (ManKey.bFire) && (Playfield.uHammerCount > 0)) {
                ...
                if (uAnimation == EMERALD_ANIM_DOWN) {
                    Playfield.pStatusAnimation[uTouchPos] = EMERALD_ANIM_AVOID_DOUBLE_CONTROL;
                } else {
        ...
        case (EMERALD_ACIDPOOL):
            ...
            Playfield.pStatusAnimation[uActPos] = EMERALD_MAN | EMERALD_ANIM_AVOID_DOUBLE_CONTROL;
